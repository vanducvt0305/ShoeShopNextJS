            ...
            <div className="flex flex-wrap items-center max-lg:gap-y-6 max-sm:gap-x-4">
                ...
                <div id="collapseMenu" className="max-lg:hidden lg:!flex lg:items-center max-lg:before:fixed max-lg:before:bg-black max-lg:before:opacity-40 max-lg:before:inset-0 max-lg:before:z-50">
                    ...
                    <ul className="lg:flex lg:gap-x-10 lg:absolute lg:left-1/2 lg:-translate-x-1/2 max-lg:space-y-3 max-lg:fixed max-lg:bg-white max-lg:w-2/3 max-lg:min-w-[300px] max-lg:top-0 max-lg:left-0 max-lg:px-10 max-lg:py-4 max-lg:h-full max-lg:shadow-md max-lg:overflow-auto z-50">
                        ...
                        <li className="max-lg:border-b max-lg:py-3"><Link href="/" className="hover:text-[#007bff] text-[15px] text-[#007bff] block font-bold">Home</Link></li>
                        <li className="group max-lg:border-b max-lg:py-3 relative">
                            <Link href="/login" className="hover:text-[#007bff] text-gray-600 font-bold text-[15px] lg:hover:fill-[#007bff] block">
                                Login
                            </Link>
                        </li>
                        <li className="group max-lg:border-b max-lg:py-3 relative">
                            <Link href="/register" className="hover:text-[#007bff] text-gray-600 font-bold text-[15px] lg:hover:fill-[#007bff] block">
                                Register
                            </Link>
                        </li>
                    </ul>
                ...
                <div className="flex items-center ml-auto space-x-8">
                    ...
                    <span className="relative">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" className="cursor-pointer fill-[#000] hover:fill-[#007bff] inline-block" viewBox="0 0 512 512">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="20px" className="cursor-pointer fill-[#000] hover:fill-[#007bff] inline-block" viewBox="0 0 371.263 371.263">
            ...
            <div className="bg-gray-100 border border-transparent focus-within:border-blue-500 focus-within:bg-transparent flex items-center px-4 rounded-full h-10 lg:w-2/4 mt-3 mx-auto max-lg:mt-6 transition-all">
                ...
                <form className='w-full' onSubmit={handleSearchSubmit}>
                    <input onChange={
                        ...
                        type="text" placeholder="Search..." className="w-full outline-none bg-transparent text-gray-600 font-semibold text-[15px]" />
                </form>
            </div>
        </header>
